...
const DelegationsTab = () => {
    ...
    return (
        <div className="flex flex-col gap-6 animate-fadeIn p-1">
            {/* Form Section */}
            <div className="flex flex-col lg:flex-row lg:items-end gap-4 sm:gap-5 p-4 sm:p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
                ...
                <div className="flex flex-col gap-1.5 w-full sm:flex-1 lg:min-w-[160px] lg:flex-none">
                ...
                <button
                    onClick={handleAdd}
                    disabled={isUpdating}
                    className="h-[38px] px-6 bg-[#24a0ed] hover:bg-[#1c8ad1] text-white rounded-[4px] text-[13px] font-semibold transition-colors disabled:opacity-50 shadow-sm flex items-center justify-center gap-2 w-full lg:w-auto lg:mb-[1px]"
                >
