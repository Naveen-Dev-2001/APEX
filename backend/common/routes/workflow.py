...
from common.ai.vector_matcher import get_cached_vendors
from common.ai.normalizer import normalize_vendor
    ...
    if not force_vendor_name and not force_vendor_id and invoice_data:
        ...
        if req_approvers is not None:
            ...
            if assigned_approvers_list is None and isinstance(invoice_data, dict):
                from common.models.db_models import InvoiceAssignedApprover
...
async def save_custom_invoice_workflow(
    ...
    from common.models.db_models import get_ist_now
